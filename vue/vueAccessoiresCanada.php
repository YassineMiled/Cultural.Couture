...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>Accessoires Canada</title>
...
<div class="nav-scroller py-1 mb-3 border-bottom">
  <nav class="nav nav-underline justify-content-center">
    ...
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"><strong class="fs-5 fw-bold">Les Accessoires du Canada</strong> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
...
<div class="row small-up-2 large-up-4">
    <div class="column">
      <img class="thumbnail" src="photos/Toque_Canada.jpg">
      <h5>Toque en Laine</h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
    <div class="column">
      <img class="thumbnail" src="photos/Mocassins_en_cuir_Canada.jpg">
      <h5>Mocassins en cuir Canada</h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
    <div class="column">
      <img class="thumbnail" src="photos/Echarpes_en_laine_Canada.jpg">
      <h5>Echarpes en laine </h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
    <div class="column">
