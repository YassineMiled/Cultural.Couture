...
<p>
    <span class="site">www.r3st0.fr</span> est édité par la société <strong>Crèsto</strong>, propriété de Lionel Romain, Ewen Prigent, et Christophe Fontaine.
</p>

<p>
    Siège social : 173 Boulevard de Strasbourg, 94130 Nogent-sur-Marne<br />
    Directeur de la publication <span>Lionel Romain</span>
</p>
<p>
...
<p>L'utilisation du site <span class="site">www.r3st0.fr</span> implique l'acceptation des conditions d'utilisations mentionnées ci-dessous.</p>
...
<div id="bilanDiv">
    <table id="bilanT">
        ...
        <tbody>
            <tr><td class="label">Consulter la page d'accueil</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>	</tr>
            <tr><td class="label">Consulter les tenues et les accessoires</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>	</tr>
            <tr><td class="label">Recherche une tenue et un accessoire</td>			<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>	</tr>
            <tr><td class="label">Mettre en favoris une tenue ou un accessoire</td>			<td class="cell">	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell">	</td>	</tr>
            <tr><td class="label">Modifier les informations personnellles de son compte</td>				<td class="cell">	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell">	</td>	</tr>
            <tr><td class="label">Consulter ses favoris</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>		<td class="cell"><img src="images/coche.png" alt="case cochée" />	</td>	</tr>
