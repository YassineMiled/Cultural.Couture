...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title> Accessoires Afghanistan</title>
...
<div class="nav-scroller py-1 mb-3 border-bottom">
  <nav class="nav nav-underline justify-content-center">
    ...
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"><strong class="fs-5 fw-bold">Les Accessoires du Afghanistan</strong> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
...
<div class="row small-up-2 large-up-4">
    <div class="column">
      <img class="thumbnail" src="photos/Chales_afghans_Afghanistan.jpg">
      <h5>Châles afghans (patu)</h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>

    <div class="column">
      <img class="thumbnail" src="photos/Chapeaux_pakols_Afghanistan.jpg">
      <h5>Chapeaux pakols</h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
    <div class="column">
