  ...
  <header class="border-bottom lh-1 py-3">
    <div class="row flex-nowrap align-items-center">
      ...
      <div class="col d-flex justify-content-end">
        ...
        <a class="btn btn-dark" href="./?action=profil" aria-label="MonProfil">Mon Profil</a>
      </div>
...
<main class="container">
  <div class="row">
    ...
    <img src="photos/photo_accueil.jpg" class="img-fluid rounded-start w-100" alt="Featured image">
    </div>
    <div class="col-lg-6 px-0">
  ...
  <div class="col-md-7 text-center my-auto">
    <h3 class="featurette-heading fw-normal lh-1">Des costumes autochtones aux influences contemporaines, explorez la diversité des tenues traditionnelles d'Amérique du Nord. <span class="text-body-secondary"> </span></h3>
    <p class="lead"></p>
...
<div class="row featurette">
  <div class="col-md-7 order-md-2 text-center my-auto">
    <h2 class="featurette-heading fw-normal lh-1">Amerique Du Sud <span class="text-body-secondary">See for yourself.</span></h2>
...
<div class="row featurette">
  <div class="col-md-7 text-center my-auto">
    <h2 class="featurette-heading fw-normal lh-1">Afrique <span class="text-body-secondary">Checkmate.</span></h2>
...
<div class="row featurette">
  <div class="col-md-7 order-md-2 text-center my-auto">
    <h2 class="featurette-heading fw-normal lh-1">Asie <span class="text-body-secondary">See for yourself.</span></h2>
    <p class="lead">Another featurette? Of course. More placeholder content here to give you an idea of how this layout would work with some actual real-world content in place.</p>
...
<div class="row featurette">
  <div class="col-md-7 text-center my-auto">
    <h2 class="featurette-heading fw-normal lh-1">Oceanie <span class="text-body-secondary">Checkmate.</span></h2>
    <p class="lead">And yes, this is the last block of representative placeholder content. Again, not really intended to be actually read, simply here to give you a better view of what this would look like with some actual content. Your content.</p>
...
<div class="row featurette">
  <div class="col-md-7 order-md-2 text-center my-auto">
    <h2 class="featurette-heading fw-normal lh-1">Europe <span class="text-body-secondary">See for yourself.</span></h2>
    <p class="lead">Another featurette? Of course. More placeholder content here to give you an idea of how this layout would work with some actual real-world content in place.</p>
