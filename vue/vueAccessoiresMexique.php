...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>Accessoires Mexique</title>
...
<div class="nav-scroller py-1 mb-3 border-bottom">
  <nav class="nav nav-underline justify-content-center">
    ...
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"><strong class="fs-5 fw-bold">Les Accessoires du Mexique</strong> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#">  </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
    <a class="nav-item nav-link link-body-emphasis" href="#"> </a>
...
<div class="row small-up-2 large-up-4">
    <div class="column">
      <img class="thumbnail" src="photos/Sombrero_Mexique.jpg">
      <h5>Sombrero</h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
    <div class="column">
      <img class="thumbnail" src="photos/Rebozos_chales traditionnels_Mexique.jpg">
      <h5>Rebozos</h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
    ...
    <div class="column">
      <img class="thumbnail" src="photos/Sandales_huaraches_Mexique.avif">
      <h5>Sandales huaraches </h5>
      <p></p>
      <a href="#" class="button expanded">Ajouter aux favoris</a>
    </div>
